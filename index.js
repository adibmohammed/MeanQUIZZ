...

{
    ...
    proposition: ["California", "Washington", "New York"]
},
...
let scoreBoard = document.getElementsByClassName('score');
    ...
    questBox.innerHTML = `${questionsArray[0].question}`;
            console.log("EVENT");
            answer1.innerHTML = `${questionsArray[0].answer[0].correct}`;
            answer2.innerHTML = `${questionsArray[0].proposition[0]}`;
            answer3.innerHTML = `${questionsArray[0].proposition[1]}`;
            answer4.innerHTML = `${questionsArray[0].proposition[2]}`;
    ...
    questBox.innerHTML = `${questionsArray[1].question}`;
    reactionBox.innerHTML = "";
    answer1.innerHTML = `${questionsArray[1].answer[0].correct}`;
    answer2.innerHTML = `${questionsArray[1].proposition[0]}`;
    answer3.innerHTML = `${questionsArray[1].proposition[1]}`;
    answer4.innerHTML = `${questionsArray[1].proposition[2]}`;
    });

    question3.addEventListener('click', () =>{
        questBox.innerHTML = `${questionsArray[2].question}`;
        reactionBox.innerHTML = "";
        answer1.innerHTML = `${questionsArray[2].answer[0].correct}`;
        answer2.innerHTML = `${questionsArray[2].proposition[0]}`;
        answer3.innerHTML = `${questionsArray[2].proposition[1]}`;
        answer4.innerHTML = `${questionsArray[2].proposition[2]}`;
        });
